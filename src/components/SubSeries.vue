<template>
    <div class="information">
        <h1 style="font-size: 1.5em;">Subseries</h1>
        <div>
...
export default {
    ...
    methods: {
        ...
        getData: async function () {
            ...
            axios
                .get('http://127.0.0.1:8000/subSeries/', {
        ...
        guardarUsuario: function (usuarioActualizado, id) {
            ...
            axios
                .put(`http://127.0.0.1:8000/subSeries/${id}/`, usuarioActualizado, {
        ...
        eliminarUsuario: function (idUsuario) {
            axios
                .delete(`http://127.0.0.1:8000/subSeries/${idUsuario}/`, {
                    headers: { Authorization: `Bearer ${localStorage.getItem('token_access')}` },
                })
                .then((response) => {
        ...
        registrarUsuario: function (nuevoUsuario) {
            axios
                .post('http://127.0.0.1:8000/subSeries/', nuevoUsuario, {
                    headers: { Authorization: `Bearer ${localStorage.getItem('token_access')}` },
                })
                .then((response) => {
